...
- Verification: 51 backend tests, a fresh Alembic migration, 87 browser tests, frontend lint and production build, dependency audits, responsive QA from 320px to 1440px, and GitHub CI and CodeQL all pass. The public demo also has a dedicated browser gate that rejects API requests, console errors, and responsive overflow.
